...
import type { ICamelotNFTPosition } from '../services/camelot';
import * as camelot from '../services/camelot';
import type { ISailfishNFTPosition } from '../services/sailfish';
import * as sailfish from '../services/sailfish';
