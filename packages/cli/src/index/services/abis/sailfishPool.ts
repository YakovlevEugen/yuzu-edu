export const sailfishPool = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'uint128',
        name: 'amountRewardRequested',
        type: 'uint128'
      }
    ],
    name: 'collectReward',
    outputs: [
      { internalType: 'uint128', name: 'amountReward', type: 'uint128' }
    ],
    stateMutability: 'nonpayable',
    type: 'function'
  },
  ...
  },
  {
    ...
    name: 'positionRewardInformation',
    outputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint8', name: 'unused', type: 'uint8' },
  ...
  {
    inputs: [{ internalType: 'int24', name: 'i', type: 'int24' }],
    name: 'ticks',
    outputs: [
