export const abi = [
  ...
  { inputs: [], name: 'CallNotAllowed', type: 'error' },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: 'outbox', type: 'address' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'tokenFeeAmount', type: 'uint256' }
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'seqMessageIndex', type: 'uint256' },
      { internalType: 'bytes32', name: 'beforeAcc', type: 'bytes32' },
      { internalType: 'bytes32', name: 'delayedAcc', type: 'bytes32' },
      { internalType: 'bytes32', name: 'acc', type: 'bytes32' }
    ],
    stateMutability: 'nonpayable',
    type: 'function'
  },
  ...
  {
    inputs: [
      { internalType: 'contract IOwnable', name: 'rollup_', type: 'address' },
      { internalType: 'address', name: 'nativeToken_', type: 'address' }
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: 'outbox', type: 'address' },
      { internalType: 'bool', name: 'enabled', type: 'bool' }
    ],
    name: 'setOutbox',
    outputs: [],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'newMsgCount', type: 'uint256' }],
  ...
  {
    inputs: [
      { internalType: 'contract IOwnable', name: '_rollup', type: 'address' }
    ],
