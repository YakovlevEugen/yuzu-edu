export const abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes', name: 'newData', type: 'bytes' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_exitNum', type: 'uint256' },
      { internalType: 'address', name: '_initialDestination', type: 'address' }
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_exitNum', type: 'uint256' },
      { internalType: 'address', name: '_initialDestination', type: 'address' },
      { internalType: 'bytes', name: '_initialData', type: 'bytes' }
    ],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_l2Counterpart', type: 'address' },
      { internalType: 'address', name: '_router', type: 'address' },
      { internalType: 'address', name: '_inbox', type: 'address' },
      { internalType: 'bytes32', name: '_cloneableProxyHash', type: 'bytes32' },
      {
        internalType: 'address',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'bool', name: 'isExit', type: 'bool' },
      { internalType: 'address', name: '_newTo', type: 'address' },
      { internalType: 'bytes', name: '_newData', type: 'bytes' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
